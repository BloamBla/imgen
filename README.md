...
- `flux2-klein-4b-edit` (v0.11.1) — the same klein-4b in **edit / image-to-image** mode: `imgen generate <photo> --model flux2-klein-4b-edit --lora <name> --custom-prompt "..."` restyles/edits an input photo while applying a klein-4b LoRA (e.g. a trained identity — it shares `flux2-klein-4b`'s LoRA compat group). Full bf16, same 32 GB envelope + gated repo as the base.
